...
export const kitList = CreateDictionary<number, TSArray<TSArray<number>>>({
    1: [
        [0 /*Knight*/],
        [78, 3127, 6673, 750, 674, 9116, 107, 2457, 635, 465, 21084], // Heroic Strike (1), Parry, Battle Shout (1), Plate Mail, Dual Wield, Shield, Block, Battle Stance, Holy Light(1), Devotion Aura(1), Judgement of Light
        [772, 100], // Rend (1), Charge (1)
        [6343, 34428, 639, 53408], // Thunderclap (1), Victory Rush, Holy Light(2), Judgement of Wisdom
        [284, 853], // Heroic Strike(2), Hammer of Justice (1)
        [355, 71, 6546, 7328], // Taunt, Defensive Stance, Rend(2), Redemption(1)
        [5242, 12697, 10290], // Battle Shout(2), Improved Charge (talent 2/2), Devotion Aura(2),
        [6572, 20271], // Revenge(1), Seal of Righteousness
        [285, 2565, 647, 31789], // Heroic Strike(3), Shield Block, Holy Light(3), Righteous Defense
        [8198, 25780], // Thunder Clap(2), Righteous Fury,
        [6547, 845, 12678, 31935, 20186], // Rend(3), Stance Mastery, Avenger's Shield, Judgement of Wisdom
        [6192, 643, 19750, 26573, 879], // Battle Shout(3), Devotion Aura(3), Flash of Light(1), Consecration(1), Exorcism(1)
        [1608, 6574, 1026], // Heroic Strike(4), Revenge(2), Holy Light(4)
        [72, 5588, 10322], // Shield Bash, Hammer of Justice(2), Redemption(2)
        [6178, 8204, 871, 19939], // Charge (2), Thunderclap(3), Shield Wall, Retribution Aura(2), Flash of Light(2)
        [6548, 5614], // Rend(4), Exorcism(2)
        [11564, 11549, 1042, 10291, 20165, 20116], // Heroic Strike(5), Battle Shout(4), Holy Light(5), Devotion Aura(4), Seal of Light, Consecration(2)
        [7379], // Revenge(3)
        [1680, 19940], // Whirlwind, Flash of Light(3)
        [8205, 5615], // Thunderclap(4), Exorcism(3)
        [11580, 53385, UTAG('battleroyale', 'paliauratest')] // Thunderclap(5), Divine Storm, Holy Spirit
    ],
    2: [
        [0 /*Berserker*/],
        [1464, 46917, 845, 2458, 9077, 8737, 12323], // Slam (1), Titan's Grip, Cleave (1), Berserker Stance, Leather, Mail, Piercing Howl
        [23881], // Bloodthirst
        [18499, 20647], // Berserker Rage, Execute
        [7369], // Cleave (2)
        [46867, 20166], // Wrecking Crew (1)
        [55694], // Enraged Regeneration
        [56927, 29759], // Unending Fury (1), Improved Berserker Stance (1)
        [20504, 12328], // Weapon Mastery (1), Sweeping Strikes
        [12319], // Flurry (1)
        [12975, 676, 57755, 6544], // Last Stand, Disarm, Heroic Throw, Heroic Leap
        [8820], // Slam (2)
        [11608, 12294], // Cleave (3), Mortal Strike (1)
        [56929, 29760], // Unending Fury(2), Improved Berserker Stance (2)
        [11604], // Slam (3)
        [21551, 20505, 56611], // Mortal Strike(2), Weapon Mastery (2), Wrecking Crew (2)
        [11605], // Slam (4)
        [11609, 21552], // Cleave (4)
        [29761, 12292], // Improved Berserker Stance (3), Death Wish
        [46924, 1719], // Bladestorm, Recklessness
    ...
    4: [
        ...
        [48667, UTAG('battleroyale', 'vendetta')], // Eviscerate (11), Vendetta
        [48657, 17347], // Backstab (12), Hemorrhage (2)
    ],
    5: [
        [0 /*Priest*/],
    ...
    7: [
        ...
        [15208, 10395, UTAG('Battleroyale','clash-of-elements')], // Lightning Bolt (10),  Healing Wave (8), Clash of elements (1)
